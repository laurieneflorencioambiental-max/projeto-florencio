...
export const proposalTemplates: ProposalTemplate[] = [
  {
    ...
    content: `A presente proposta tem por objeto a prestação de serviços de consultoria completa em Saúde e Segurança do Trabalho (SST), incluindo:
...
- Suporte contínuo e assessoria para atendimento às Normas Regulamentadoras.`,
  },
  {
    ...
    content: `Objeto: Capacitação dos colaboradores para atendimento à Norma Regulamentadora nº 12 - Segurança no Trabalho em Máquinas e Equipamentos.
...
- Práticas de operação segura e manutenção.`,
  },
  {
    ...
    content: `Esta proposta contempla os seguintes serviços para regularização e segurança contra incêndio:
