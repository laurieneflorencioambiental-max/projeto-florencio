...
export const initialLeads: Lead[] = [
  {
    ...
    value: 15000,
    paymentMethods: [{ method: 'Boleto' }, { method: 'Cartão de Crédito/Débito', cardFee: 3.5 }],
  ...
  },
  {
    ...
    value: 8500,
    paymentMethods: [{ method: 'Cartão de Crédito/Débito', cardFee: 4.0 }],
  ...
  },
  {
    ...
    value: 12000,
    paymentMethods: [{ method: 'Boleto' }, { method: 'Cartão de Crédito/Débito', cardFee: 3.8 }],
  ...
  },
  {
    ...
    value: 25000,
    paymentMethods: [{ method: 'Cartão de Crédito/Débito', cardFee: 3.2 }],
