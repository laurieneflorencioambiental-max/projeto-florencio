...
import { Trash2, PlusCircle, Save, Pencil, X, Loader2, FileDown } from 'lucide-react';
                              ...
                              <CommandGroup>
                                  {(pricingTemplates || []).map((template) => (
                                      <CommandItem
                                          ...
                                          value={template.name}
                                          onSelect={() => {
                                              form.setValue('service', template.name, { shouldValidate: true });
                                              form.setValue('description', `Baseado no modelo de precificação para ${template.serviceType}`, { shouldValidate: true });
